========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Matrix
========================================================================


Diese Matrix-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Matrix.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Matrix.rc eingebunden.
...
MatrixDlg.h, MatrixDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CMatrixDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in Matrix.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	Matrix.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
