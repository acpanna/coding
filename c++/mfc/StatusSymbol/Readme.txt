========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : StatusSymbol
========================================================================


Diese StatusSymbol-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre StatusSymbol-Anwendung bilden.
...
StatusSymbol.h
	...
	Anwendungsklasse CStatusSymbolApp.
...
res\StatusSymbol.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei StatusSymbol.rc eingebunden.

res\StatusSymbol.rc2
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in StatusSymbol.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

StatusSymbolDoc.h, StatusSymbolDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CStatusSymbolDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CStatusSymbolDoc::Serialize).

StatusSymbolView.h, StatusSymbolView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CStatusSymbolView.
    	CStatusSymbolView-Objekte werden verwendet, um CStatusSymbolDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	StatusSymbol.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
