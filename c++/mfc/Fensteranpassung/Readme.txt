========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Fensteranpassung
========================================================================


Diese Fensteranpassung-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Fensteranpassung-Anwendung bilden.

Fensteranpassung.dsp
...
Fensteranpassung.h
	...
	Anwendungsklasse CFensteranpassungApp.

Fensteranpassung.cpp
...
res\Fensteranpassung.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei Fensteranpassung.rc eingebunden.

res\Fensteranpassung.rc2
...
FensteranpassungDoc.h, FensteranpassungDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CFensteranpassungDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CFensteranpassungDoc::Serialize).

FensteranpassungView.h, FensteranpassungView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CFensteranpassungView.
    	CFensteranpassungView-Objekte werden verwendet, um CFensteranpassungDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Fensteranpassung.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
