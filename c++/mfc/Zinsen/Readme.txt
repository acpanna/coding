========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Zinsen
========================================================================


Diese Zinsen-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Zinsen.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Zinsen.rc eingebunden.
...
ZinsenDlg.h, ZinsenDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CZinsenDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in Zinsen.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	Zinsen.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
