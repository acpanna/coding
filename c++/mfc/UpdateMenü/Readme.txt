========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : UpdateMenü
========================================================================


Diese UpdateMenü-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre UpdateMenü-Anwendung bilden.
...
UpdateMenü.h
	...
	Anwendungsklasse CUpdateMenApp.
...
res\UpdateMenü.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei UpdateMenü.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in UpdateMenü.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

UpdateMenüDoc.h, UpdateMenüDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CUpdateMenDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CUpdateMenDoc::Serialize).

UpdateMenüView.h, UpdateMenüView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CUpdateMenView.
    	CUpdateMenView-Objekte werden verwendet, um CUpdateMenDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	UpdateMenü.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
