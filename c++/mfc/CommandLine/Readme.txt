========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Test
========================================================================


Diese Test-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Test.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Test.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in Test.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

TestDoc.h, TestDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CTestDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CTestDoc::Serialize).

TestView.h, TestView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CTestView.
    	CTestView-Objekte werden verwendet, um CTestDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Test.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
