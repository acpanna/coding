========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Hello_W3
========================================================================


Diese Hello_W3-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Hello_W3-Anwendung bilden.
...
res\Hello_W3.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Hello_W3.rc eingebunden.
...
Hello_W3Doc.h, Hello_W3Doc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CHello_W3Doc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CHello_W3Doc::Serialize).

Hello_W3View.h, Hello_W3View.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CHello_W3View.
    	CHello_W3View-Objekte werden verwendet, um CHello_W3Doc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Hello_W3.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
