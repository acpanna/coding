========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Menü
========================================================================


Diese Menü-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Menü.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Menü.rc eingebunden.
...
res\Toolbar.bmp
    ...
    aktualisieren Sie IDR_MAINFRAME TOOLBAR in Menü.rc, um Schaltflächen für die
    Symbolleiste hinzuzufügen.
/////////////////////////////////////////////////////////////////////////////

Der Klassen-Assistent erstellt einen Dokumenttyp und eine Ansicht(View):

MenüDoc.h, MenüDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CMenDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CMenDoc::Serialize).

MenüView.h, MenüView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CMenView.
    	CMenView-Objekte werden verwendet, um CMenDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Menü.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
