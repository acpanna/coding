========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Kreise
========================================================================


Diese Kreise-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Kreise.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Kreise.rc eingebunden.
...
KreiseDoc.h, KreiseDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CKreiseDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CKreiseDoc::Serialize).

KreiseView.h, KreiseView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CKreiseView.
    	CKreiseView-Objekte werden verwendet, um CKreiseDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Kreise.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
