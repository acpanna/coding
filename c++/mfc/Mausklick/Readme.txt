========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Mausklick
========================================================================


Diese Mausklick-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Mausklick-Anwendung bilden.
...
Mausklick.h
	...
	Anwendungsklasse CMausklickApp.
...
res\Mausklick.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Mausklick.rc eingebunden.
...
MausklickDoc.h, MausklickDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CMausklickDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CMausklickDoc::Serialize).

MausklickView.h, MausklickView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CMausklickView.
    	CMausklickView-Objekte werden verwendet, um CMausklickDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Mausklick.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
