========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Kontextmenü
========================================================================


Diese Kontextmenü-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Kontextmenü-Anwendung bilden.
...
Kontextmenü.h
	...
	Anwendungsklasse CKontextmenApp.
...
res\Kontextmenü.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Kontextmenü.rc eingebunden.
...
KontextmenüDoc.h, KontextmenüDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CKontextmenDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CKontextmenDoc::Serialize).

KontextmenüView.h, KontextmenüView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CKontextmenView.
    	CKontextmenView-Objekte werden verwendet, um CKontextmenDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Kontextmenü.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
