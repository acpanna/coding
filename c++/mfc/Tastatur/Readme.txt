========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Tastatur
========================================================================


Diese Tastatur-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Tastatur-Anwendung bilden.
...
res\Tastatur.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Tastatur.rc eingebunden.
...
TastaturDoc.h, TastaturDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CTastaturDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CTastaturDoc::Serialize).

TastaturView.h, TastaturView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CTastaturView.
    	CTastaturView-Objekte werden verwendet, um CTastaturDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Tastatur.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
