========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Dialog
========================================================================


Diese Dialog-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Dialog.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Dialog.rc eingebunden.
...
DialogDlg.h, DialogDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CDialogDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in Dialog.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	Dialog.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
