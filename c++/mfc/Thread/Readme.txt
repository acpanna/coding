========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Thread
========================================================================


Diese Thread-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Thread.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Thread.rc eingebunden.
...
ThreadDoc.h, ThreadDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CThreadDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CThreadDoc::Serialize).

ThreadView.h, ThreadView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CThreadView.
    	CThreadView-Objekte werden verwendet, um CThreadDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Thread.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
