========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : InternetCash
========================================================================


Diese InternetCash-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre InternetCash-Anwendung bilden.
...
InternetCash.h
	...
	Anwendungsklasse CInternetCashApp.
...
res\InternetCash.ico
    Dies ist eine Symboldatei, die als Symbol für die Anwendung verwendet wird. Dieses 
	Symbol wird durch die Haupt-Ressourcendatei InternetCash.rc eingebunden.

res\InternetCash.rc2
...
InternetCashDlg.h, InternetCashDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CInternetCashDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in InternetCash.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	InternetCash.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
