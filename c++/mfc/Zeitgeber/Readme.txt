========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Zeitgeber
========================================================================


Diese Zeitgeber-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Zeitgeber-Anwendung bilden.
...
Zeitgeber.h
	...
	Anwendungsklasse CZeitgeberApp.
...
res\Zeitgeber.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Zeitgeber.rc eingebunden.
...
ZeitgeberDoc.h, ZeitgeberDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CZeitgeberDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CZeitgeberDoc::Serialize).

ZeitgeberView.h, ZeitgeberView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CZeitgeberView.
    	CZeitgeberView-Objekte werden verwendet, um CZeitgeberDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Zeitgeber.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
