========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Zeichnen1
========================================================================


Diese Zeichnen1-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre Zeichnen1-Anwendung bilden.
...
Zeichnen1.h
	...
	Anwendungsklasse CZeichnen1App.
...
res\Zeichnen1.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Zeichnen1.rc eingebunden.
...
Zeichnen1Doc.h, Zeichnen1Doc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CZeichnen1Doc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CZeichnen1Doc::Serialize).

Zeichnen1View.h, Zeichnen1View.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CZeichnen1View.
    	CZeichnen1View-Objekte werden verwendet, um CZeichnen1Doc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Zeichnen1.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
