========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : Mauese
========================================================================


Diese Mauese-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
res\Mauese.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei Mauese.rc eingebunden.
...
MaueseDoc.h, MaueseDoc.cpp - das Dokument
    	Diese Dateien enthalten die Klasse CMaueseDoc. Bearbeiten Sie diese Dateien,
  	um Ihre speziellen Dokumentdaten hinzuzufügen und das Speichern und Laden von 
	Dateien zu implementieren (mit Hilfe von CMaueseDoc::Serialize).

MaueseView.h, MaueseView.cpp - die Ansicht des Dokuments
    	Diese Dateien enthalten die Klasse CMaueseView.
    	CMaueseView-Objekte werden verwendet, um CMaueseDoc-Objekte anzuzeigen.
...
StdAfx.h, StdAfx.cpp
	...
	Mauese.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
