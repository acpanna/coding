...
$(document).ready(function () {
    var url, name, gallery = true, id,
        pkBaseURL = (("https:" === document.location.protocol) ? "https://fibonacci.uni-bayreuth.de/stats/" : "http://fibonacci.uni-bayreuth.de/stats/"),
        piwikTracker;
    ...
    // check for metro app
    if (!JXG.isMetroApp() && typeof Piwik === 'object') {
        try {
